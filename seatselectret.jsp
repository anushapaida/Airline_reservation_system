...
<html>
    ...
    <form action = "Seatselectret" method = "post">
    <header>
	<h1 style="background-color: #A7C942; color: white">Return Flight</h1>
	</header>
	...
	<input type="hidden" id="seatSelectedret" name = "seatSelectedret" >
	<div>
...
ResultSet resultSet = null;
		...
		resultSet = statement.executeQuery("SELECT * FROM Seat where idAirplane = '"+ returnFlight +"'");
	...
	function changeColor(name) {
			...
			if(curPass < totalPassengers) { 
				if(but.style.backgroundColor == "aqua")
				{
					...
					curPass = curPass + 1;
					document.getElementById('seatSelectedret').value += name +'&';
				}			
